...
def get_route(hostname):
    ...
    for ttl in range(1,MAX_HOPS):
        for tries in range(TRIES):
            ...
            mySocket = socket(AF_INET, SOCK_RAW, proto) # Make a raw socket named mySocket
            #Fill in end
            ...
            try:
                ...
                try: #try to fetch the hostname
                    #Fill in start
                    hostHostname = gethostbyaddr(addr[0])[0]
                    #Fill in end
                except herror:   #if the host does not provide a hostname
                    #Fill in start
                    hostHostname = "Cannot fetch Hosthame"
                    #Fill in end
                ...
                if types == 11:
                    ...
                    #Fill in start
                    tracelist1.append("Exception - Something Went Wrong")
                    #If there is an exception/error to your if statements, you should append that to your list here
                    #Fill in end
                break
            finally:
                #for test in tracelist2:
                    #print(test)
                mySocket.close()
